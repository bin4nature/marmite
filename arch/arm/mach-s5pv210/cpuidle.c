...
static int s5p_init_cpuidle(void)
{
	...
	device->states[1].target_residency = 9000; //DAVE: TOP ON always needs to be equal or higher
	...
	device->states[2].target_residency = 8000; //DAVE: TOP OFF - check 2000 and start from 8000 and go up in 1000s
